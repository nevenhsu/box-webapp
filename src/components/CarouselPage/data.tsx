...
const slides: TDetail[] = [
  {
    ...
    link: 'https://meta.box3.fun/space/city',
    sceneProps: {
      z: 26,
      intensity: 2,
  ...
  },
  {
    ...
    link: 'https://meta.box3.fun/space/ugc',
    sceneProps: {
      z: 22.5,
      intensity: 2,
  ...
  },
  {
    ...
    link: 'https://meta.box3.fun/space/cultural-tourism',
    sceneProps: {
      z: 28,
      intensity: 0.5,
  ...
  },
  {
    ...
    link: 'https://meta.box3.fun/space/culture-entertain',
    sceneProps: {
      z: 28,
      intensity: 1,
  ...
  },
  {
    ...
    link: 'https://meta.box3.fun/space/gallery',
    sceneProps: {
      z: 28,
      intensity: 2,
  ...
  },
  {
    ...
    link: 'https://meta.box3.fun/space/company',
    sceneProps: {
      z: 26,
      intensity: 4,
